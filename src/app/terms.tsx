...
const title = 'Terms of Service - MicroPng'
const description = 'The rules of the road for using MicroPng.'
const canonicalUrl = 'https://micropng.sahilfruitwala.com/terms'
