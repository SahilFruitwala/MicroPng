...
export const metadata: Metadata = {
  ...
  description: 'Fast, secure, and professional-grade image compression directly in your browser. Lossless optimization for PNG, JPEG, and WebP.',
  keywords: ['image compression', 'compress png', 'compress jpeg', 'optimize images', 'web performance', 'local compression', 'privacy focused'],
